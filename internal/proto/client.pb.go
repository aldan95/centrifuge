...
func NewPopulatedSubscribeResult(r randyClient, easy bool) *SubscribeResult {
	...
	if r.Intn(10) != 0 {
		...
		for i := 0; i < v12; i++ {
			v13 := NewPopulatedPublication(r, easy)
			this.Publications[i] = *v13
		}
	}
...
func NewPopulatedHistoryResult(r randyClient, easy bool) *HistoryResult {
	...
	if r.Intn(10) != 0 {
		...
		for i := 0; i < v16; i++ {
			v17 := NewPopulatedPublication(r, easy)
			this.Publications[i] = *v17
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
var fileDescriptorClient = []byte{
	...
	,
}
